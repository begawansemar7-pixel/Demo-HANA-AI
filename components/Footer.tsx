...
const SocialIcon: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <a href="#" className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-halal-green hover:text-white dark:hover:bg-accent-gold dark:hover:text-halal-green transition-colors">
    {children}
  </a>
);
...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-12 pb-24 md:pb-0">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          <div>
            <h4 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">{t('footer.about.title')}</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">{t('footer.about.description')}</p>
          </div>
          <div>
          ...
          <div>
            <h4 className="font-bold mb-2 text-gray-900 dark:text-white">{t('footer.contact.title')}</h4>
            <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h4 className="font-bold mb-4 text-center text-gray-900 dark:text-white">{t('footer.social.title')}</h4>
