...
const AuditLogIcon = () => React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-8 w-8", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
...
export const SERVICES: Service[] = [
  ...
  { id: 'audit-log', title: 'home.services.items.auditLog', icon: AuditLogIcon(), personas: ['auditor'] },
